...
namespace Lab_7_2_
{
    class Plane : Device, IDevice<Plane>, IEngine<Plane>, IPart<Plane>, IComparable<Plane>, ICloneable
    {
        public int capacity;
        ...
        public Plane(string deviceName, string deviceType, int capacity, bool isMatchEngine, bool isElectric) : base(deviceName, deviceType, isElectric, isMatchEngine)
        {

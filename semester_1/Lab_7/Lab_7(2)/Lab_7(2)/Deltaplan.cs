...
namespace Lab_7_2_
{
    internal class Deltaplan : Device, IDevice<Deltaplan>, IEngine<Deltaplan>, IPart<Deltaplan>, IComparable<Deltaplan>
    {
        public int capacity;
        ...
        public Deltaplan(string deviceName, string deviceType, int capacity, bool isMatchEngine, bool isElectric) : base(deviceName, deviceType, isElectric, isMatchEngine)
        {
        ...
        public int CompareTo(Deltaplan obj)
        {
            Deltaplan plane = (Deltaplan)obj;
